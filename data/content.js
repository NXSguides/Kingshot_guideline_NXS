  ...
  "eternity-reach": {
    ...
    sections: {
      ...
      ko: { title: "사라진 유적", blocks: [
        ...
        { type: "h", text: "중요한 이유" },
        { type: "p", text: "영주 부적 재료를 얻을 수 있는 최고의 반복 수급처 중 하나입니다." },
        { type: "h", text: "전략" },
        { type: "sub", text: "스킬" },
      ...
      de: { title: "Weiten der Ewigkeit", blocks: [
        ...
        { type: "p", text: "Eine der besten wiederkehrenden Quellen für Gouverneurs-Amulett-Materialien." },
      ...
      fr: { title: "l'Éternité à Portée", blocks: [
        ...
        { type: "p", text: "L'une des meilleures sources récurrentes de matériaux pour le Charme du Gouverneur." },
      ...
      pt: { title: "Alcance da Eternidade", blocks: [
        ...
        { type: "p", text: "Uma das melhores fontes recorrentes de materiais para o Amuleto do Governador." },
      ...
      id: { title: "Eternity's Reach", blocks: [
        ...
        { type: "p", text: "Salah satu sumber terbaik dan berulang untuk material Jimat Gubernur." },
      ...
      ru: { title: "Предел бесконечности", blocks: [
        ...
        { type: "p", text: "Один из лучших регулярных источников материалов для Оберега губернатора." },
      ...
      ar: { title: "وصول الأبدية", blocks: [
        ...
        { type: "p", text: "أحد أفضل المصادر المتكررة لمواد تعويذة الحاكم." },
