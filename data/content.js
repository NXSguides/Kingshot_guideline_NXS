...
const GLOSSARY = {
  ...
  zoe: { zh:"佐伊", en:"Zoe", ko:"조이", de:"Zoe", fr:"Zoé" },
  hilde: { zh:"希爾德", en:"Hilde", ko:"힐데", de:"Hilde" },
  marlin: { zh:"馬林", en:"Marlin", ko:"마린", de:"Marlin", pt:"Peixe Marlin" },
...
"kvk": {
  ...
  sections: {
    zh: { title: "KvK 準備與戰鬥指南（Gen 3 版本）", blocks: [
      ...
      { type: "p", text: "計分項目：{truegold}建築升級、建設加速、{governorGear}寶石、情報任務、Masters 技能加速。" },
    ...
    en: { title: "KvK Prep & Battle Guide (Gen 3 Era)", blocks: [
      ...
      { type: "p", text: "Scoring Activities: {truegold} building upgrades, Construction Speedups, {governorGear} Charms, Intel Missions, Master Skill Speedups." },
      ...
      { type: "p", text: "Scoring Activities: Research Speedups, {truegoldDust} (Tech), Hero Shards (Rare/Epic/Mythic), Hero Roulette spins, Master Emblems/Manuscripts, Gathering Resources." },
      { type: "p", text: "**🛡️ F2P Focus:**" },
      ...
      { type: "p", text: "**⚡ P2W Focus:**" },
      { type: "list", items: ["Max out {truegoldDust} research in the {academy}.", "Burn all saved Master Emblems and Manuscripts.", "Rank up Gen 3 heroes (Eric & Petra) to 5-star instantly."]},
      { type: "sub", text: "Day 3: Pet Training & Master Progression" },
      { type: "p", text: "Scoring Activities: {petAdvancement}, {commonTamingMarks} & {advancedTamingMarks} (Refining), Hero Roulette, Hero Shards, Master Emblems/Manuscripts, Intel Missions." },
      { type: "p", text: "**🛡️ F2P Focus:**" },
    ...
    ko: { title: "KvK 준비 및 전투 가이드 (Gen 3 시대)", blocks: [
      ...
      { type: "p", text: "점수 활동: {truegold} 건물 업그레이드, 건설 가속, {governorGear} 보석, 정보 임무, Masters 스킬 가속." },
      ...
      { type: "p", text: "**🛡️ F2P 중점:**" },
      { type: "list", items: ["낮은 등급 부대를 현재 최고 등급으로 승급시키세요 (예: T9를 T10으로). 신병을 처음부터 훈련하는 것보다 부대를 승급시키는 것이 자원 효율이 훨씬 좋습니다.", "일반 가속은 연구/Masters용으로 남겨두고, 여기서는 전용 부대 훈련 가속만 사용하세요."]},
      { type: "p", text: "**⚡ P2W 중점:**" },
    ...
    de: { title: "KvK-Vorbereitungs- & Kampfguide (Gen-3-Ära)", blocks: [
      ...
      { type: "p", text: "Punktebringende Aktivitäten: {truegold}-Gebäude-Upgrades, Bau-Beschleunigungen, {governorGear}-Talismane, Geheimdienstmissionen, Master-Fähigkeiten-Beschleunigungen." },
    ...
    fr: { title: "Guide de Préparation et Combat KvK (Ère Gen 3)", blocks: [
      ...
      { type: "p", text: "Activités notées : améliorations de bâtiments {truegold}, Accélérations de Construction, Talismans {governorGear}, Missions de Renseignement, Accélérations de Compétence Master." },
    ...
    pt: { title: "Guia de Preparação e Batalha KvK (Era Gen 3)", blocks: [
      ...
      { type: "p", text: "Atividades que pontuam: melhorias de construção com {truegold}, Velocidades de Construção, Amuletos {governorGear}, Missões de Inteligência, Velocidades de Habilidade Master." },
    ...
    tr: { title: "KvK Hazırlık ve Savaş Rehberi (Gen 3 Dönemi)", blocks: [
      ...
      { type: "p", text: "Puan Kazandıran Aktiviteler: {truegold} bina yükseltmeleri, İnşaat Hızlandırmaları, {governorGear} Tılsımları, İstihbarat Görevleri, Master Yeteneği Hızlandırmaları." },
    ...
    id: { title: "Panduan Persiapan & Pertempuran KvK (Era Gen 3)", blocks: [
      ...
      { type: "p", text: "Aktivitas Bernilai: peningkatan bangunan {truegold}, Speedup Konstruksi, Charm {governorGear}, Misi Intel, Speedup Skill Master." },
    ...
    ru: { title: "Гайд по подготовке и битве KvK (Эпоха Gen 3)", blocks: [
      ...
      { type: "p", text: "Активности, приносящие очки: улучшения зданий {truegold}, ускорения строительства, талисманы {governorGear}, разведывательные задания, ускорения навыков Masters." },
    ...
    th: { title: "คู่มือเตรียมตัวและการต่อสู้ KvK (ยุค Gen 3)", blocks: [
      ...
      { type: "p", text: "กิจกรรมที่ได้คะแนน: การอัปเกรดอาคาร {truegold}, เร่งสปีดการก่อสร้าง, เครื่องราง {governorGear}, ภารกิจข่าวกรอง, เร่งสปีดสกิล Masters" },
    ...
    ar: { title: "دليل استعداد وقتال KvK (حقبة Gen 3)", blocks: [
      ...
      { type: "p", text: "الأنشطة المحتسبة: ترقيات مباني {truegold}، تسريعات البناء، تمائم {governorGear}، مهام الاستخبارات، تسريعات مهارات Masters." },
